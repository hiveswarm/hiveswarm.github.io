...
try:
    # Set commands for getting data from sensor
    MQ2cmd = 0x01
    MQ7cmd = 0x02
    MQ135cmd = 0x03
    PMcmd = 0x04
    ...
    connection.connect()
    connection.request('POST', '/classes/Environmental', json.dumps({
        "temperature": temperature * 1.8 + 32,
        "humidity": humidity,
        "carbon_monoxide_ppm" : MQ7_Gases[3],
        "ammonia_ppm" : MQ135_Gases[1],
	    "carbon_dioxide_ppm" : MQ135_Gases[2],
	    "methly_ppm" : MQ135_Gases[4],
	    "acetone_ppm" : MQ135_Gases[5],
	    "methane_ppm" : MQ2_Gases[1],
	    "lpg_ppm" : MQ2_Gases[5],
	    "hydrogen_ppm" : MQ2_Gases[3],
	    "propane_ppm" : MQ2_Gases[4],
	    "pm10" : PM.Get_PMDensity(PMcmd),
	    "ip_address" : get_interface_ipaddress('wlan0')
    }), {
      "X-Parse-Application-Id": "UdWhIAwhRmgyxKrR6xNEPwaNzMI008RBQOrAgJNd",
      "X-Parse-Master-Key": "XrNb6ZJwKTzJxvba8gmdxYe596xZfxU5hWkVlmJi",
